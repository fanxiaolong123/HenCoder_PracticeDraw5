...
public class Practice01AfterOnDrawView extends AppCompatImageView {
    ...
    public Practice01AfterOnDrawView(Context context, @Nullable AttributeSet attrs, int
            defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable != null) {
            ...
            canvas.drawText(getResources().getString(R.string.image_size, bounds.width(), bounds
                    .height()), 20, 40, paint);
            canvas.restore();
        }
